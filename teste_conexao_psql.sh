...
secret_string=$(aws secretsmanager get-secret-value --secret-id rds!db-e8cb0dc4-d321-4af4-854a-2b1e75cb55d9 --version-stage AWSCURRENT --query SecretString --output text)
